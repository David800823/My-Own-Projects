...
-- Step 1: Using the right data
-- I imported the csv into MySQL
...
;
-- I joined the table against itself to get the previous year and the next year 
-- Then I got the average of both to fill in the missing life expectancy
...
;
-- Result --
-- Developed countries make up 16.6% of the dataset
-- While Developing countries make up 83.9% of the dataset
...
-- I will do a running total for adult mortality
